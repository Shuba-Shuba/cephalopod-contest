summon skeleton ~ ~ ~ {DeathLootTable:"",CustomName:'{"text":"null"}',ArmorItems:[{},{},{},{id:"minecraft:netherite_helmet",count:1,components:{"minecraft:unbreakable":{}}}],HandItems:[{},{}],Tags:["sentry"],Attributes:[{Base:40.0d,Name:"max_health"}],Health:40.0f,NoAI:1b,PersistenceRequired:1b}
tag @s add me
