...
summon skeleton ~ ~ ~ {DeathLootTable:"",CustomName:{text:"null"},ArmorItems:[{},{},{},{id:"minecraft:golden_helmet",count:1,components:{"minecraft:unbreakable":{}}}],HandItems:[{},{}],Tags:["sentry"],attributes:[{base:40.0d,id:"max_health"}],Health:40.0f,NoAI:1b,PersistenceRequired:1b}
tag @s add me
