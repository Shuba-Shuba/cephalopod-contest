...
give @s minecraft:trident[unbreakable={},enchantments={loyalty:10},attribute_modifiers={modifiers:[{operation:"add_value",type:"attack_damage",amount:3,slot:"mainhand",id:"melee"}],show_in_tooltip:0b},custom_name='{"text":"Trident (3 melee damage)","italic":false}']
