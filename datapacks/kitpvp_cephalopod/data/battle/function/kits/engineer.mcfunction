...
item replace entity @s armor.head with minecraft:golden_helmet[custom_name='[{"text":"Hardhat","color":"white","italic":false}]',custom_model_data=11001,attribute_modifiers={modifiers:[{operation:"add_value",type:"armor",amount:2,slot:"head",id:"armor"}],show_in_tooltip:0b}]
