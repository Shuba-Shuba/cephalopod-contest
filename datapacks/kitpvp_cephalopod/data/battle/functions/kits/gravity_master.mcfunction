...
give @s minecraft:stone_shovel[custom_name='{"text":"Market Gardener","color":"aqua","italic":false}',lore=['{"text":"bonk","color":"gray"}'],unbreakable={},enchantments={"minecraft:knockback":1},attribute_modifiers=[{operation:"add_value",type:"generic.movement_speed",amount:0.05d,slot:"mainhand",name:"generic.movement_speed",uuid:[I;855022582,-237616447,-1954130516,661217818]},{operation:"add_value",type:"generic.attack_damage",amount:3,slot:"mainhand",name:"generic.attack_damage",uuid:[I;-554110992,521686562,-1412403182,304833256]}]] 1
