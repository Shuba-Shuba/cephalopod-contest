...
item replace entity @s armor.head with minecraft:leather_helmet[unbreakable={},custom_name='"Cowboy Hat"',lore=['"YEE HAW"'],attribute_modifiers=[{operation:"add_value",type:"generic.attack_damage",amount:3,slot:"head",name:"generic.attack_damage",uuid:[I;439028749,-342432341,294819041,-298502513]}]]
