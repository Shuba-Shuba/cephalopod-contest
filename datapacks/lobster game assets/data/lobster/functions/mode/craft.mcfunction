...
execute in sp:void run tp @a[tag=tmp_unteleported] 211 163 1071 -90 20
execute as @r[tag=tmp_unteleported] in sp:void positioned 208 133 1093 run function lobster:craft_spawn_start
...
# crafting list
execute in sp:void run function lobster:craft_makelist
execute as @e[type=marker,tag=craft_storage] run data modify entity @s data.craft set from storage lobster:craft recipes
execute as @e[type=marker,tag=craft_storage] run data modify entity @s data.names set from storage lobster:craft names
