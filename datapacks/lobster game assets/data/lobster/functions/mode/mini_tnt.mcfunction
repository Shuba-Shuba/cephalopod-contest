...
kill @e[type=arrow]
execute in sp:void run spreadplayers 616 -584 8 25 under 45 false @a[tag=!out,tag=!ded]
...
item replace entity @a[scores={class=0}] hotbar.4 with golden_pickaxe{Enchantments:[{id:"efficiency",lvl:255}],CanDestroy:["#lobster:all"],HideFlags:8}
...
execute as @a[scores={class=1}] at @s run function lobster:give_level_bomb
...
#item replace entity @a[scores={class=2}] hotbar.3 with stray_spawn_egg{EntityTag:{id:"minecraft:skeleton",Invulnerable:1b,CustomName:'{"text":"Dispenser"}',ArmorItems:[{},{},{},{id:"minecraft:furnace",Count:1b}],HandItems:[{},{}],Tags:["dispenser","build"],NoAI:1b,DeathLootTable:"",ArmorDropChances:[0f,0f,0f,0f],HandDropChances:[0f,0f]},HideFlags:16,CanPlaceOn:["#lobster:all"],display:{Name:'{"text":"[FREE] Build Dispenser","italic":false}'}}
item replace entity @a[scores={class=2}] hotbar.4 with golden_pickaxe{display:{Name:'{"text":"Metal Miner","italic":false}'},Enchantments:[{id:"efficiency",lvl:255s}],CanDestroy:["#lobster:all"],HideFlags:8,tnt:18b}
