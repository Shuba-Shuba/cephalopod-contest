...
$execute unless score #bool game matches 1 store success score #bool game positioned ~ ~ ~.1 if block ~ ~ ~ $(name) run tp @s ~ ~ ~
$execute unless score #bool game matches 1 store success score #bool game positioned ~ ~ ~-.1 if block ~ ~ ~ $(name) run tp @s ~ ~ ~
$execute unless score #bool game matches 1 run function lobster:tag_block_search_deep {"name":"$(name)"}
...
execute at @s align xyz positioned ~.5 ~ ~.5 as @e[type=slime,tag=init] run function lobster:tag_block