...
## use item
# nitro boat karts
execute if score %mode game matches 16 if score .id itembox_cd matches 0 run schedule function lobster:lightning_remove 1s
execute if score %mode game matches 16 if score .id itembox_cd matches 0 as @a[tag=!this] at @s positioned ~ ~0.5 ~ run function lobster:item_lightning
execute if score %mode game matches 16 if score .id itembox_cd matches 1 run function lobster:item_blooper
execute if score %mode game matches 16 if score .id itembox_cd matches 2 run function lobster:item_coke
# nun run
execute if score %mode game matches 9 if data entity @s {Inventory:[{Slot:-106b,id:"minecraft:sugar"}]} run function lobster:super_nun
execute if score %mode game matches 9 if data entity @s {Inventory:[{Slot:-106b,id:"minecraft:nether_star"}]} run function lobster:stun_the_sinful
execute if score %mode game matches 9 if data entity @s {Inventory:[{Slot:-106b,id:"minecraft:turtle_egg"}]} run function lobster:judgement
# kitpvp weapons
...
execute if data entity @s {Inventory:[{Slot:-106b,id:"minecraft:tnt"}]} if score @s Kit_ID matches 29 run function lobster:landed
...
execute if data entity @s {Inventory:[{Slot:-106b,id:"minecraft:book"}]} if score @s Kit_ID matches 32 unless score @s tp_cd matches 1.. run function lobster:teleporter_use
execute if data entity @s {Inventory:[{Slot:-106b,id:"minecraft:evoker_spawn_egg"}]} run function lobster:evoker
...
# mini tnt
execute if score %mode game matches 24 run function lobster:swap_hands
execute if score %mode game matches 24 run function lobster:tnt_rightclick

## end
tag @s remove this
execute if score %mode game matches 16 run item replace entity @s weapon.offhand with air
execute if score %mode game matches 21 unless score @s Kit_ID matches 23 unless score @s Kit_ID matches 25 run function lobster:swap_hands
