...
# set clock
execute if score %second_clock game matches ..9 run bossbar set lobster:time name ["",{"score":{"objective":"game","name":"%minute"}},":0",{"score":{"objective":"game","name":"%second_clock"}}]
execute if score %second_clock game matches 10.. run bossbar set lobster:time name ["",{"score":{"objective":"game","name":"%minute"}},":",{"score":{"objective":"game","name":"%second_clock"}}]
