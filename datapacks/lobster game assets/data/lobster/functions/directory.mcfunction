...
execute if score %level arrow matches 69 at @s[type=!arrow] run function lobster:dodgeball_hit
...
execute if score %level arrow matches 35 at @s[type=player] run function lobster:tag_entity
execute if score %level arrow matches 35 at @s[type=arrow] if data entity @s {inBlockState:{Name:"minecraft:barrier"}} on passengers run function lobster:tag_invalid
...
execute if score %level arrow matches 35 at @s[type=arrow] unless data entity @s {inBlockState:{Name:"minecraft:barrier"}} on passengers run function lobster:tag_block_search with storage tmp inBlockState

kill @s[type=arrow]
execute if score %level arrow matches 35 run kill @e[type=marker,tag=tnt_triangulator,predicate=!lobster:is_riding_arrow]