...
execute if score %second game matches 0 if score %tick game matches 0 run function lobster:sumo_timer
...
execute if score %players game matches ..1 unless score %replay game matches 1.. run function lobster:sumo_end
execute if score %replay game matches 2 run function lobster:end
execute if score %replay game matches 3 run function lobster:sumo_start