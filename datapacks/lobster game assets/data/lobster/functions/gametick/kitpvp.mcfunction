...
execute as @a[scores={deaths=1..},tag=!out,tag=!ded,predicate=lobster:spawn] run function lobster:death_kitpvp
execute as @a[scores={kills=1..},tag=!out,tag=!ded] run function lobster:kill_kitpvp
...
execute if score %second game matches ..0 run function lobster:kitpvp_end
