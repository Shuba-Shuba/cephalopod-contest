...
execute if score %tick game matches 20.. run function lobster:clock_cs
...
execute as @e[type=marker,tag=cs] at @s if block ~ ~ ~ tnt run function lobster:planted_bomb
execute as @e[type=tnt,tag=cs] at @s run scoreboard players add @a[team=red,predicate=lobster:sneaking,distance=..2] defuse 1
execute as @e[type=tnt,tag=cs] at @s run scoreboard players set @a[team=red,predicate=!lobster:sneaking,distance=..2] defuse 0
...
execute unless score #tmp_ended game matches 1 if entity @a[team=red,scores={defuse=200..}] run function lobster:cs_defuse_end
execute unless score #tmp_ended game matches 1 unless entity @a[tag=!ded,team=red] run function lobster:cs_blue_end
execute unless score #tmp_ended game matches 1 unless entity @a[tag=!ded,team=blue] unless score .cs_bomb game matches 1 run function lobster:cs_red_end
