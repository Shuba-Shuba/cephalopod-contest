# clock
execute as @a[scores={deaths=1..},tag=!out,tag=!ded] run function lobster:death_genwars
execute as @a[tag=tmp_dead,predicate=lobster:spawn] run function lobster:death_genwars1
scoreboard players add %tick game 1
execute if score %tick game matches 20.. run scoreboard players add %second game 1
execute if score %tick game matches 20.. as @a[scores={death_time=0}] run function lobster:respawn_genwars
...
# split gen
execute as @a[scores={split_iron=1..}] at @s run function lobster:split_iron
execute as @a[scores={split_gold=1..}] at @s run function lobster:split_gold
...
execute as @a[scores={armor_check=1..}] run function lobster:armor_chainmail
execute as @a store result score @s armor_check run clear @s iron_chestplate{armor_level:3b}
execute as @a[scores={armor_check=1..}] run function lobster:armor_iron
execute as @a store result score @s armor_check run clear @s diamond_chestplate{armor_level:4b}
execute as @a[scores={armor_check=1..}] run function lobster:armor_diamond
execute as @a store result score @s armor_check run clear @s enchanted_book{upgrade:1b}
execute as @a[scores={armor_check=1..}] run function lobster:upgrade_sharp
execute as @a store result score @s armor_check run clear @s golden_pickaxe{upgrade:1b}
execute as @a[scores={armor_check=1..}] run function lobster:upgrade_haste
execute as @a[predicate=lobster:holding_unsharp_sword] run item modify entity @s weapon.mainhand lobster:sharp
...
# bed breaking
execute as @a[tag=!out,tag=!ded,scores={break_red=1..}] run function lobster:break_red
execute as @a[tag=!out,tag=!ded,scores={break_blue=1..}] run function lobster:break_blue
execute as @a[tag=!out,tag=!ded,scores={break_green=1..}] run function lobster:break_green
execute as @a[tag=!out,tag=!ded,scores={break_yellow=1..}] run function lobster:break_yellow
...
execute if entity @a[tag=winner] if score %replay game matches 2 run function lobster:end