# clock
execute as @a[tag=!out,tag=!ded,tag=!winner] at @s if block ~ ~-1 ~ orange_concrete_powder run function lobster:death
execute as @a[tag=!out,tag=!ded,tag=!winner] at @s if block ~ ~-1 ~ lime_stained_glass run function lobster:death
execute as @a[tag=!out,tag=!ded,tag=!winner] at @s if block ~ ~-1 ~ light_blue_stained_glass run function lobster:death
...
execute if block 107 63 -227 lever[powered=true] if block 107 63 -230 lever[powered=true] if block 107 63 -233 lever[powered=true] run function lobster:make_key