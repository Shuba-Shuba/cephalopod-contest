...
execute as @a[scores={boss_fight_class=0}] positioned -372 74 2 run function lobster:boss_class_get
execute as @a[scores={boss_fight_class=1}] positioned -370 74 2 run function lobster:boss_class_get
execute as @a[scores={boss_fight_class=2}] positioned -374 74 2 run function lobster:boss_class_get
execute as @a[scores={boss_fight_class=3}] positioned -376 74 2 run function lobster:boss_class_get
...
# announce classes
execute as @a[tag=!out,tag=!ded] run function lobster:boss_class_say
...
# setup health bar
bossbar set lobster:time color pink
bossbar set lobster:time max 200
bossbar set lobster:time name "Ender Dragon"