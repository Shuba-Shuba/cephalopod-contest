...
execute if score .sys tnt_arrow matches 1 unless data entity @s {inBlockState:{Name:"minecraft:barrier"}} on origin run function lobster:summon_crystal
...
execute if score .sys tnt_arrow matches 1 if data entity @s {inBlockState:{Name:"minecraft:barrier"}} on origin run function lobster:arrow_reload
