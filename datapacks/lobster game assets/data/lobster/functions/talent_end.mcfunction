...
execute if score %map game matches 0 in sp:void run tp @a[tag=stage,tag=!ded] 601 107 519 0 0
clear @a[tag=stage,tag=!ded]

# get new performer
tag @a remove stage
tag @r[tag=!stage_done,tag=!ded,tag=!out] add stage
execute if score %map game matches 0 in sp:void run tp @a[tag=stage] 601 108 534 180 0
...
give @a[tag=stage] minecraft:netherite_pickaxe{Unbreakable:1b,CanDestroy:["#lobster:all"],Enchantments:[{id:"efficiency",lvl:255}]}
give @a[tag=stage] minecraft:netherite_axe{Unbreakable:1b,CanDestroy:["#lobster:all"],Enchantments:[{id:"efficiency",lvl:255}]}
give @a[tag=stage] minecraft:netherite_shovel{Unbreakable:1b,CanDestroy:["#lobster:all"],Enchantments:[{id:"efficiency",lvl:255}]}
give @a[tag=stage] minecraft:netherite_hoe{Unbreakable:1b,CanDestroy:["#lobster:all"],Enchantments:[{id:"efficiency",lvl:255}]}
loot give @a[tag=stage] loot lobster:improv