...
execute if score %map game matches 0 if score %camera1 game matches 10 run function lobster:camera_move {duration:50,to:"1515 72 241"}
execute if score %map game matches 0 if score %camera1 game matches 60 run function lobster:camera_move {duration:50,to:"1515 72 146"}
execute if score %map game matches 0 if score %camera1 game matches 110 run function lobster:camera_move {duration:45,to:"1531 72 57"}
execute if score %map game matches 0 if score %camera1 game matches 155 run function lobster:camera_move {duration:25,to:"1519 72 9"}
execute if score %map game matches 0 if score %camera1 game matches 180 run function lobster:camera_move {duration:30,to:"1506 72 67"}
...
execute if score %map game matches 1 if score %camera1 game matches 10 run function lobster:camera_move {duration:35,to:"1644 100 87"}
execute if score %map game matches 1 if score %camera1 game matches 45 run function lobster:camera_move {duration:35,to:"1569 100 87"}
execute if score %map game matches 1 if score %camera1 game matches 80 run function lobster:camera_move {duration:13,to:"1569 76 87"}
execute if score %map game matches 1 if score %camera1 game matches 93 run function lobster:camera_move {duration:30,to:"1563 75 42"}
execute if score %map game matches 1 if score %camera1 game matches 123 run function lobster:camera_move {duration:12,to:"1567 75 15"}
execute if score %map game matches 1 if score %camera1 game matches 135 run function lobster:camera_move {duration:15,to:"1584 75 8"}
execute if score %map game matches 1 if score %camera1 game matches 150 run function lobster:camera_move {duration:22,to:"1621 74 18"}
execute if score %map game matches 1 if score %camera1 game matches 172 run function lobster:camera_move {duration:15,to:"1637 74 29"}
execute if score %map game matches 1 if score %camera1 game matches 187 run function lobster:camera_move {duration:15,to:"1663 73 14"}
execute if score %map game matches 1 if score %camera1 game matches 202 run function lobster:camera_move {duration:8,to:"1679 73 18"}
