...
execute as @a[tag=!out,tag=!ded] if score @s koth = %least koth run function lobster:landed
execute as @a[tag=!out,tag=!ded] if score @s koth = %least koth run function lobster:death
