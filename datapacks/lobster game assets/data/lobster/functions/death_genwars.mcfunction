...
execute as @p[scores={kills=1..}] run loot give @s loot lobster:steal
...
item modify entity @s armor.head lobster:prot
item modify entity @s armor.chest lobster:prot
item modify entity @s armor.legs lobster:prot
item modify entity @s armor.feet lobster:prot
item replace entity @s hotbar.0 with wooden_sword{Unbreakable:1b,CanDestroy:["#lobster:placeable"],HideFlags:8}