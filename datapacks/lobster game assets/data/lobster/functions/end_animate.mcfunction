...
#execute in sp:void run tp @a[tag=!out] -3 201 3
execute in sp:void as @a[tag=!out,predicate=!lobster:is_riding_camera] run ride @s mount @e[type=armor_stand,tag=camera,limit=1]