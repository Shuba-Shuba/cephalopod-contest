...
execute as @a[team=red] at @s positioned ~-220 ~-122 ~-771 if predicate lobster:elevator_generic run tp @s 268.0 122 771.0 90 0
schedule function lobster:open/hotel 60s