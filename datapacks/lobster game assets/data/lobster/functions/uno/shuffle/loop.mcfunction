...
function lobster:uno/shuffle/get

# shift partition
execute store result score .bool deck if predicate lobster:rng50
...
# loop
execute if score .size deck matches 1.. run function lobster:uno/shuffle/loop