...
execute in cc:void run summon minecraft:glow_item_frame 244 127 696 {Facing:2b,Invisible:1b,Tags:["shard"],Item:{id:"minecraft:echo_shard",Count:1b,tag:{shard:1b}}}
