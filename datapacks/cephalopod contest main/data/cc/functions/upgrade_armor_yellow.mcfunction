...
item modify entity @a[team=yellow] armor.head cc:prot
item modify entity @a[team=yellow] armor.chest cc:prot
item modify entity @a[team=yellow] armor.legs cc:prot
item modify entity @a[team=yellow] armor.feet cc:prot