...
execute as @r[tag=tmp_unteleported] in sp:void positioned 208 133 1093 run function cc:craft_spawn_start
...
# crafting list
execute in sp:void run function cc:craft_makelist
