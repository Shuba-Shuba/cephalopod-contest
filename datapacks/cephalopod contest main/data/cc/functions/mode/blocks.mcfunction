...
execute as @r[tag=tmp_unteleported] in sp:void positioned 205 137 1024 run function cc:blocks_spawn_start
...
execute positioned 200 164 1025 in sp:void run function cc:blocks_fill_global
execute positioned 200 164 1024 in sp:void run function cc:blocks_fill_global
execute positioned 200 164 1023 in sp:void run function cc:blocks_fill_global
execute positioned 200 165 1025 in sp:void run function cc:blocks_fill_global
execute positioned 200 165 1024 in sp:void run function cc:blocks_fill_global
execute positioned 200 165 1023 in sp:void run function cc:blocks_fill_global
execute positioned 200 166 1025 in sp:void run function cc:blocks_fill_global
execute positioned 200 166 1024 in sp:void run function cc:blocks_fill_global
execute positioned 200 166 1023 in sp:void run function cc:blocks_fill_global
