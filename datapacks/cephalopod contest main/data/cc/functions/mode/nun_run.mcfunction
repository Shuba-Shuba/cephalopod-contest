...
execute in cc:void run summon minecraft:glow_item_frame -243 91 697 {Facing:5b,Invisible:1b,Item:{id:"minecraft:prismarine_shard",Count:1b,tag:{shard:1b}},Tags:["shard"]}
