summon skeleton ~ ~ ~ {DeathLootTable:"cc:heist_mob",Team:"blue",PersistenceRequired:1b,Tags:["heist","heist_ranged","this"],HandItems:[{id:"minecraft:bow",Count:1b,tag:{CustomModelData:201}},{}],HandDropChances:[0.000F,0.000F],ArmorItems:[{},{},{},{id:"minecraft:netherite_helmet",Count:1b,tag:{Unbreakable:1b}}],ArmorDropChances:[0.000F,0.000F,0.000F,0.000F],Health:8.0f}
