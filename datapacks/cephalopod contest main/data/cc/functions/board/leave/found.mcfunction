...
$summon zombie ~ ~ ~ {Tags:["board_player_placeholder","init"],NoAI:1b,Invulnerable:1b,ArmorItems:[{},{},{},{id:"minecraft:turtle_helmet",Count:1b,tag:{Unbreakable:1b}}],CustomNameVisible:1b,CustomName:'"$(name) (OFFLINE)"'}
