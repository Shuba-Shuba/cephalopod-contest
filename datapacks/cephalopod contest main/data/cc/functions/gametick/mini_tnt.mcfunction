...
execute as @e[type=minecraft:arrow,nbt={inGround:1b},x=590,y=-18,z=-610,dx=53,dy=337,dz=53] at @s if dimension sp:void run function cc:tnt_arrow
...
# NUL freeze potion
execute as @e[type=potion,tag=!freeze,nbt={Item:{tag:{custom_potion_effects:[{id:"minecraft:water_breathing",amplifier:32b}]}}}] run function cc:freeze_potion
...
item replace entity @a[scores={build_dispenser_cd=1}] hotbar.3 with stray_spawn_egg{EntityTag:{id:"minecraft:skeleton",Passengers:[{id:"minecraft:arrow"}],Invulnerable:1b,CustomName:'{"text":"Dispenser"}',ArmorItems:[{},{},{},{id:"minecraft:furnace",Count:1b}],Tags:["dispenser","build"],NoAI:1b,DeathLootTable:"",ArmorDropChances:[0f,0f,0f,0f],HandDropChances:[0f,0f]},HideFlags:16,CanPlaceOn:["#cc:all"],display:{Name:'{"text":"Build Dispenser","italic":false}'}}
...
item replace entity @a[scores={class=2,metal_mine_cd=1}] hotbar.4 with golden_pickaxe{display:{Name:'{"text":"Metal Miner","italic":false}'},Enchantments:[{id:"efficiency",lvl:255}],CanDestroy:["#cc:all"],HideFlags:8,tnt:18b}
