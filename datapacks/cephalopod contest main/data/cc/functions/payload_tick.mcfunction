...
# cart changed states
execute if score .payload game matches 0 if score .payload_prev game matches 1 run function cc:payload_unpush
execute if score .payload game matches 1.. if score .payload_prev game matches 0 run function cc:payload_push

# cart being pushed
execute if score .payload game matches 1.. run function cc:payload_push_init