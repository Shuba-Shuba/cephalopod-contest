...
item modify entity @a[team=red] armor.head cc:prot
item modify entity @a[team=red] armor.chest cc:prot
item modify entity @a[team=red] armor.legs cc:prot
item modify entity @a[team=red] armor.feet cc:prot