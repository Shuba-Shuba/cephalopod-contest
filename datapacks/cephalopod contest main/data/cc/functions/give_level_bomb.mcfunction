...
item replace entity @s hotbar.2 with creeper_spawn_egg{tnt:2b,HideFlags:16,CanPlaceOn:["#cc:all"],EntityTag:{id:"minecraft:marker",Tags:["bomb_level_init"],data:{level:0}},display:{Name:'{"text":"Creeper Bomb","italic":false}'}}
