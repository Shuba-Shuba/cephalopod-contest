...
execute if score %in game matches 1 if score cameras.enabled config matches 1 in sp:void run function cc:camera
...
execute if score %in game matches 1 if score %mode game matches 0 in sp:void run function cc:gametick/lights_out
execute if score %in game matches 1 if score %mode game matches 1 in sp:void run function cc:gametick/parkour
execute if score %in game matches 1 if score %mode game matches 2 in sp:void run function cc:gametick/bomb_tag
execute if score %in game matches 1 if score %mode game matches 3 in sp:void run function cc:gametick/race
execute if score %in game matches 1 if score %mode game matches 4 in sp:void run function cc:gametick/red_light_green_light
execute if score %in game matches 1 if score %mode game matches 5 in sp:void run function cc:gametick/buttons
execute if score %in game matches 1 if score %mode game matches 6 in sp:void run function cc:gametick/koth
execute if score %in game matches 1 if score %mode game matches 7 in sp:void run function cc:gametick/rocks
execute if score %in game matches 1 if score %mode game matches 8 in sp:void run function cc:gametick/dodgeball
execute if score %in game matches 1 if score %mode game matches 9 in sp:void run function cc:gametick/nun_run
execute if score %in game matches 1 if score %mode game matches 10 in sp:void run function cc:gametick/sumo
execute if score %in game matches 1 if score %mode game matches 11 in sp:void run function cc:gametick/blocks
execute if score %in game matches 1 if score %mode game matches 12 in sp:void run function cc:gametick/craft
execute if score %in game matches 1 if score %mode game matches 13 in sp:void run function cc:gametick/gun_game
execute if score %in game matches 1 if score %mode game matches 14 in sp:void run function cc:gametick/drugs
execute if score %in game matches 1 if score %mode game matches 15 in sp:void run function cc:gametick/skywars
execute if score %in game matches 1 if score %mode game matches 16 in sp:void run function cc:gametick/nbk
execute if score %in game matches 1 if score %mode game matches 17 in sp:void run function cc:gametick/spleef
execute if score %in game matches 1 if score %mode game matches 18 in sp:void run function cc:gametick/uno
execute if score %in game matches 1 if score %mode game matches 19 in sp:void run function cc:gametick/admintato
execute if score %in game matches 1 if score %mode game matches 20 in sp:void run function cc:gametick/talent
execute if score %in game matches 1 if score %mode game matches 21 in sp:void run function cc:gametick/kitpvp
execute if score %in game matches 1 if score %mode game matches 22 in sp:void run function cc:gametick/genwars
execute if score %in game matches 1 if score %mode game matches 23 in sp:void run function cc:gametick/dog_fight
execute if score %in game matches 1 if score %mode game matches 24 in sp:void run function cc:gametick/mini_tnt
execute if score %in game matches 1 if score %mode game matches 25 in sp:void run function cc:gametick/micro_battles
execute if score %in game matches 1 if score %mode game matches 26 in sp:void run function cc:gametick/payload
execute if score %in game matches 1 if score %mode game matches 27 in sp:void run function cc:gametick/cs
...
execute if score %in game matches 1 if score %mode game matches 29 in sp:void run function cc:gametick/disco
execute if score %in game matches 1 if score %mode game matches 69 in sp:void run function cc:gametick/shard_room
execute if score %in game matches 1 if score %mode game matches 420 in sp:void run function cc:gametick/chunk
...
execute if score autospawn.enabled config matches 1 unless entity Steve positioned 0 69 0 in sp:void as Shuba_Shuba run function cc:carpet_player_spawn
execute if score autospawn.enabled config matches 1 unless entity Steve1 positioned 0 69 0 in sp:void as Shuba_Shuba run function cc:carpet_player_spawn
execute if score autospawn.enabled config matches 1 unless entity Steve2 positioned 0 69 0 in sp:void as Shuba_Shuba run function cc:carpet_player_spawn
execute if score autospawn.enabled config matches 1 unless entity steve3 positioned 0 69 0 in sp:void as Shuba_Shuba run function cc:carpet_player_spawn