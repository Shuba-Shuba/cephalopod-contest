...
execute unless score .hotel heist matches 1.. unless entity @s[team=blue] run function cc:heist/hotel
...
execute if score .hotel heist matches 1 if entity @s[team=blue] run function cc:close/hotel