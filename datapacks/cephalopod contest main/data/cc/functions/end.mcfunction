...
# genwars reset
execute in sp:void run fill 1230 -64 -151 1406 0 -322 air replace #cc:placeable
execute in sp:void run fill 950 -64 -200 1050 50 -300 air replace #cc:placeable
...
execute if score cc.one config matches 0 unless score #end_schedule game matches 1.. if score %winners game matches 0..1 in sp:void run function cc:end_screen
...
execute if score cc.one config matches 0 if score #end_schedule game matches 2 if score %winners game matches 0..1 in sp:void run tp @a[tag=!out] 0 200 0
...
execute if score cc.one config matches 1 unless score #end_schedule game matches 1.. in sp:void run function cc:end_screen
...
execute if score cc.one config matches 1 if score #end_schedule game matches 2 in sp:void run tp @a[tag=!out] 0 200 0
