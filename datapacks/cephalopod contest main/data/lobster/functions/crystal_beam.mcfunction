...
execute store result storage lobster:crystal pos.X int 1 run data get entity @s Pos[0]
...
execute store result storage lobster:crystal pos.Y int 0.99 run data get entity @s Pos[1] 0.99
execute store result storage lobster:crystal pos.Z int 1 run data get entity @s Pos[2]
execute as @e[type=end_crystal,tag=owned_crystal] run data modify entity @s BeamTarget set from storage lobster:crystal pos
...
execute if score @s tag_time matches 30.. if entity @s[type=slime] as @e[type=end_crystal,tag=owned_crystal] run summon tnt ~ ~ ~ {fuse:4s,NoGravity:1b,Tags:["bedrock"]}
execute if score @s tag_time matches 30.. as @s[type=player] run function lobster:untag_entity
