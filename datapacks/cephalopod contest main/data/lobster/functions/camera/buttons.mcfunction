...
execute if score %map game matches 0 if score %camera1 game matches 0 run summon item_display 175 89 106 {view_range:0f,item:{id:"minecraft:air",Count:1b},Tags:["camera"]}
