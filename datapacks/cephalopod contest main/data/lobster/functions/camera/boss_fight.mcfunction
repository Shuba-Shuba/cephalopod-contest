...
execute if score %map game matches 0 if score %camera1 game matches 60 run place template lobster:boss_fight -80 0 -80
...
execute if score %map game matches 0 if score %camera1 game matches 0 run function lobster:camera_move {duration:59,to:"0 80 15"}
execute if score %map game matches 0 if score %camera1 game matches 61 run function lobster:camera_move {duration:59,to:"-15 80 0"}
execute if score %map game matches 0 if score %camera1 game matches 120 run function lobster:camera_move {duration:59,to:"0 80 -15"}
execute if score %map game matches 0 if score %camera1 game matches 179 run function lobster:camera_move {duration:59,to:"15 80 0"}
