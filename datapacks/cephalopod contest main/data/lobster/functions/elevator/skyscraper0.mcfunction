...
execute unless score .skyscraper heist matches 1.. unless entity @s[team=blue] run function lobster:heist/skyscraper
...
execute if score .skyscraper heist matches 1 if entity @s[team=blue] run function lobster:close/skyscraper