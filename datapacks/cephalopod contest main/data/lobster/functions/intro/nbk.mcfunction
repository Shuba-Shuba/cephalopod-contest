...
# choose map
execute if score %map game matches 0 in sp:void run tp @a[tag=!out] 1521 71 344 180 0
execute if score %map game matches 1 in sp:void run tp @a[tag=!out] 1717 96 87 90 0
...
execute as @a[tag=!out,tag=!ded] at @s run function lobster:jail_nbk
function lobster:nbk_start