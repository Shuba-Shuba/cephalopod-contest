...
execute unless entity 0000000d-0109-0097-0116-000000000104 run function lobster:distance_setup
...
data merge storage lobster:disco {wool:["red_concrete","blue_concrete","cyan_concrete","gray_concrete","lime_concrete","pink_concrete","black_concrete","brown_concrete","green_concrete","orange_concrete","purple_concrete","white_concrete","yellow_concrete","magenta_concrete","light_blue_concrete","light_gray_concrete"]}
