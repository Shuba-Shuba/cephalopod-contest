...
execute if score %map game matches 2 unless score sumo_hazards.enabled config matches 1 run place template lobster:sumo2_normal -222 112 1263
execute if score %map game matches 2 if score sumo_hazards.enabled config matches 1 run place template lobster:sumo2_hazards -222 112 1263
...
schedule function lobster:sumo_start_timer 3s
function rep:reset
