...
execute store result bossbar lobster:time max run scoreboard players get time.lights_out config
execute store result bossbar lobster:time value run scoreboard players get time.lights_out config
