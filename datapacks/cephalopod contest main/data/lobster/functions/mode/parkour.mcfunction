...
execute store result bossbar lobster:time max run scoreboard players get time.glass_jumps config
execute store result bossbar lobster:time value run scoreboard players get time.glass_jumps config
