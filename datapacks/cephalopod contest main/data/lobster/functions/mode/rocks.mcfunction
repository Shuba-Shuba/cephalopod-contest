...
execute as @e[type=marker,tag=platform,tag=tmp_map,sort=random] at @s run function lobster:rock_tp
...
bossbar set lobster:time max 50
bossbar set lobster:time value 50
