...
execute as @a[scores={night_vision=1..}] run function lobster:night_toggle
execute in sp:void run spawnpoint @a 0 69 0
#execute in sp:void run spawnpoint @a -254 70 -618
...
execute as @e[type=arrow,nbt={custom_potion_effects:[{id:"minecraft:water_breathing"}],inGround:1b}] run function lobster:directory
execute as @e[type=!arrow,nbt={active_effects:[{id:"minecraft:water_breathing"}]}] run function lobster:directory
...
execute if score %in game matches 1 if score cameras.enabled config matches 1 in sp:void run function lobster:camera

# gameticks
execute if score %mode game matches -2 run function lobster:end_animate
execute if score %in game matches 1 if score %mode game matches -1 as @a[gamemode=!spectator,gamemode=!creative] at @s if block ~ ~-1 ~ barrier run function lobster:landed_no_kb
execute if score %in game matches 1 if score %mode game matches -1 run effect give @a resistance 1 255 true
execute if score %in game matches 1 if score %mode game matches 0 in sp:void run function lobster:gametick/lights_out
execute if score %in game matches 1 if score %mode game matches 1 in sp:void run function lobster:gametick/parkour
execute if score %in game matches 1 if score %mode game matches 2 in sp:void run function lobster:gametick/bomb_tag
execute if score %in game matches 1 if score %mode game matches 3 in sp:void run function lobster:gametick/race
execute if score %in game matches 1 if score %mode game matches 4 in sp:void run function lobster:gametick/red_light_green_light
execute if score %in game matches 1 if score %mode game matches 5 in sp:void run function lobster:gametick/buttons
execute if score %in game matches 1 if score %mode game matches 6 in sp:void run function lobster:gametick/koth
execute if score %in game matches 1 if score %mode game matches 7 in sp:void run function lobster:gametick/rocks
execute if score %in game matches 1 if score %mode game matches 8 in sp:void run function lobster:gametick/dodgeball
execute if score %in game matches 1 if score %mode game matches 9 in sp:void run function lobster:gametick/nun_run
execute if score %in game matches 1 if score %mode game matches 10 in sp:void run function lobster:gametick/sumo
execute if score %in game matches 1 if score %mode game matches 11 in sp:void run function lobster:gametick/blocks
execute if score %in game matches 1 if score %mode game matches 12 in sp:void run function lobster:gametick/craft
execute if score %in game matches 1 if score %mode game matches 13 in sp:void run function lobster:gametick/gun_game
execute if score %in game matches 1 if score %mode game matches 14 in sp:void run function lobster:gametick/drugs
execute if score %in game matches 1 if score %mode game matches 15 in sp:void run function lobster:gametick/skywars
execute if score %in game matches 1 if score %mode game matches 16 in sp:void run function lobster:gametick/nbk
execute if score %in game matches 1 if score %mode game matches 17 in sp:void run function lobster:gametick/spleef
execute if score %in game matches 1 if score %mode game matches 18 in sp:void run function lobster:gametick/uno
execute if score %in game matches 1 if score %mode game matches 19 in sp:void run function lobster:gametick/admintato
execute if score %in game matches 1 if score %mode game matches 20 in sp:void run function lobster:gametick/talent
execute if score %in game matches 1 if score %mode game matches 21 in sp:void run function lobster:gametick/kitpvp
execute if score %in game matches 1 if score %mode game matches 22 in sp:void run function lobster:gametick/genwars
execute if score %in game matches 1 if score %mode game matches 23 in sp:void run function lobster:gametick/dog_fight
execute if score %in game matches 1 if score %mode game matches 24 in sp:void run function lobster:gametick/mini_tnt
execute if score %in game matches 1 if score %mode game matches 25 in sp:void run function lobster:gametick/micro_battles
execute if score %in game matches 1 if score %mode game matches 26 in sp:void run function lobster:gametick/payload
execute if score %in game matches 1 if score %mode game matches 27 in sp:void run function lobster:gametick/cs
execute if score %in game matches 1 if score %mode game matches 28 in minecraft:the_end run function lobster:gametick/boss_fight
execute if score %in game matches 1 if score %mode game matches 29 in sp:void run function lobster:gametick/disco
execute if score %in game matches 1 if score %mode game matches 69 in sp:void run function lobster:gametick/shard_room
execute if score %in game matches 1 if score %mode game matches 420 in sp:void run function lobster:gametick/chunk
...
#execute if score %antipenis game matches 1000 as betaRadiation run function lobster:gbj
...
# tether
#execute as @e[tag=gravity,type=armor_stand] at @s run function lobster:gravity/victim
#execute as @a[scores={gravity=1}] at @s run function lobster:gravity/tether
#execute if score %mode game matches 8 run effect clear @a[scores={gravity=0}] levitation

# gun game portals
effect give @a[predicate=lobster:portal1] blindness 2 0 true
effect give @a[predicate=lobster:portal2] blindness 2 0 true
effect give @a[predicate=lobster:portal3] blindness 2 0 true
effect give @a[predicate=lobster:portal3] resistance 2 255 true
execute store result score #advancement game run gamerule announceAdvancements
gamerule announceAdvancements true
advancement grant @a[predicate=lobster:portal1_trigger] only lobster:portal
advancement grant @a[predicate=lobster:portal2_trigger] only lobster:portal
execute if score #advancement game matches 0 run gamerule announceAdvancements false
execute as @a[predicate=lobster:portal1_trigger] at @s run tp @s ~-51 ~ ~-33
execute as @a[predicate=lobster:portal2_trigger] at @s run tp @s ~51 ~ ~33
execute as @a[predicate=lobster:portal3_trigger] at @s run tp @s ~ ~71 ~
execute as @a[predicate=lobster:ufo_beam0] at @s run tp @s ~-50 ~ ~
execute as @a[predicate=lobster:ufo_beam1] at @s run tp @s ~ ~5 ~-50
execute unless score %mode game matches 14 as @a[predicate=lobster:elevator_skyscraper3] at @s run tp ~-69 ~-22 ~8
...
execute as @a[scores={reset_times=1..}] run function lobster:ui/reset_times
...
# evoker weapon
execute as @a[scores={evoker_click=1..},nbt={SelectedItem:{tag:{evoker:1b}}}] at @s run function lobster:evoker
scoreboard players set @a evoker_click 0
scoreboard players remove @a[scores={evoker_cd=1..}] evoker_cd 1

# throwable fireball
execute as @a[scores={fireball_click=1..},nbt={SelectedItem:{tag:{CustomModelData:200}}}] at @s run function lobster:fireball
scoreboard players set @a fireball_click 0
execute as @e[type=fireball,tag=fireball,tag=save] run function lobster:motion_fix
...
execute as @e[type=marker,tag=fireball,predicate=!lobster:is_riding_fireball] at @s run function lobster:fireball_hit

# constant velocity arrows
execute as @e[type=arrow,tag=save] run function lobster:motion_fix
...
execute if score autospawn.enabled config matches 1 unless entity Steve positioned 0 69 0 in sp:void as Shuba_Shuba run function lobster:carpet_player_spawn
execute if score autospawn.enabled config matches 1 unless entity Steve1 positioned 0 69 0 in sp:void as Shuba_Shuba run function lobster:carpet_player_spawn
execute if score autospawn.enabled config matches 1 unless entity Steve2 positioned 0 69 0 in sp:void as Shuba_Shuba run function lobster:carpet_player_spawn
execute if score autospawn.enabled config matches 1 unless entity steve3 positioned 0 69 0 in sp:void as Shuba_Shuba run function lobster:carpet_player_spawn