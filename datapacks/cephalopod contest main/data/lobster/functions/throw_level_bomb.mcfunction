...
execute anchored eyes run summon snowball ^ ^ ^ {Tags:["level_bomb_carrier","shb"],Item:{Count:1b,id:"minecraft:creeper_spawn_egg"},Passengers:[{id:"minecraft:marker",Tags:["bomb_level_init"],data:{level:0}}]}
