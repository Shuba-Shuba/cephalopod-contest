advancement revoke @s only lobster:craft_check
...
execute if score @s craft2 matches 0 unless score #tmp_ended game matches 1 run function lobster:craft_complete
