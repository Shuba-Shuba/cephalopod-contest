...
schedule function cc:mode/mini_tnt 12s
...
execute if score tnt.force_class config matches -2 run tellraw @a [\
    ...
    {text:"Random\n","underlined":true,bold:true,click_event:{action:"run_command",command:"/trigger mini_tnt_class set -1"},hover_event:{action:"show_text",value:"/trigger mini_tnt_class set -1"}},\
    {text:"Gardener\n",color:"dark_green","underlined":true,bold:true,click_event:{action:"run_command",command:"/trigger mini_tnt_class set 0"},hover_event:{action:"show_text",value:"/trigger mini_tnt_class set 0"}},\
    {text:"Technician\n",color:"aqua","underlined":true,bold:true,click_event:{action:"run_command",command:"/trigger mini_tnt_class set 1"},hover_event:{action:"show_text",value:"/trigger mini_tnt_class set 1"}},\
    {text:"Engineer\n",color:"yellow","underlined":true,bold:true,click_event:{action:"run_command",command:"/trigger mini_tnt_class set 2"},hover_event:{action:"show_text",value:"/trigger mini_tnt_class set 2"}},\
    {text:"Architect",color:"light_purple","underlined":true,bold:true,click_event:{action:"run_command",command:"/trigger mini_tnt_class set 3"},hover_event:{action:"show_text",value:"/trigger mini_tnt_class set 3"}}\
]
