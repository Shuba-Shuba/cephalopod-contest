...
# tools
give @a[tag=!out] minecraft:netherite_pickaxe[enchantments={"minecraft:efficiency":5},can_break={blocks:["minecraft:cobblestone","minecraft:coal_ore","minecraft:iron_ore","minecraft:gold_ore","minecraft:diamond_ore","minecraft:redstone_ore","minecraft:ancient_debris","minecraft:obsidian"]}]
give @a[tag=!out] minecraft:netherite_axe[enchantments={"minecraft:efficiency":5},can_break={blocks:["minecraft:oak_planks","minecraft:bookshelf"]}]
give @a[tag=!out] minecraft:netherite_shovel[enchantments={"minecraft:efficiency":5},can_break={blocks:["minecraft:gravel","minecraft:sand"]}]
