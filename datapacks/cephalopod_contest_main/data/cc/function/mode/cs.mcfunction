...
give @a[tag=!out,tag=!ded] minecraft:iron_sword[unbreakable={},enchantments={sharpness:1},item_model="cc:dagger",custom_name={text:"Knife",italic:false},attribute_modifiers=[{operation:"add_multiplied_base",type:"movement_speed",amount:0.2d,slot:"mainhand",id:"speed"}]]
