...
execute store result score item.bat game run clear @s wooden_sword[item_model="cc:bat"] 1
...
execute if score item.bat game matches 1.. run give @s minecraft:wooden_sword[item_model="cc:bat",unbreakable={},custom_name={text:"Baseball Bat",italic:false}]
