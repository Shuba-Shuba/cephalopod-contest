...
execute unless entity @a[tag=tmp_unteleported] positioned ~17 ~ ~ run function cc:blocks_spawn_end
execute if entity @a[tag=tmp_unteleported] as @r[tag=tmp_unteleported] positioned ~17 ~ ~ run function cc:blocks_spawn