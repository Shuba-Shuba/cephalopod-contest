...
execute if score %camera1 game matches 0 if score %map game matches 0 run summon minecraft:item_display -215 118 1034 {view_range:0.0f,item:{id:"minecraft:air",count:1b},Tags:["camera"]}
execute if score %camera1 game matches 0 if score %map game matches 1 run summon minecraft:item_display -215 118 1152 {view_range:0.0f,item:{id:"minecraft:air",count:1b},Tags:["camera"]}
execute if score %camera1 game matches 0 if score %map game matches 2 run summon minecraft:item_display -215 118 1270 {view_range:0.0f,item:{id:"minecraft:air",count:1b},Tags:["camera"]}
