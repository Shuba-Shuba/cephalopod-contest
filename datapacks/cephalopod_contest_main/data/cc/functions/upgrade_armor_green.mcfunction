...
item modify entity @a[team=green] armor.head cc:prot
item modify entity @a[team=green] armor.chest cc:prot
item modify entity @a[team=green] armor.legs cc:prot
item modify entity @a[team=green] armor.feet cc:prot