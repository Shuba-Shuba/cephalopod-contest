...
execute in cc:void run summon glow_item_frame 103 63 -214 {Invisible:1b,Item:{id:"minecraft:amethyst_shard",count:1,components:{"minecraft:custom_data":{shard:1b}}},Facing:4b,Tags:["shard"]}
