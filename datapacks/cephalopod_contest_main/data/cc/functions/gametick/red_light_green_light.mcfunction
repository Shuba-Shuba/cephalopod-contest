...
execute as @a[tag=!out,tag=!ded,tag=!winner] at @s if score %tmp_light game matches 1 run function cc:run_on_red_check
...
execute if score %tmp_light2 game matches 0 run function cc:light_change
