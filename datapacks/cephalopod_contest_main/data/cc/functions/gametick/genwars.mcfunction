...
execute as @e[type=marker,tag=gen_forge,scores={gen_level=1}] if score @s iron >= gen.i1 config at @s run summon item ~ ~ ~ {Item:{id:"minecraft:iron_ingot",count:1,components:{"minecraft:custom_data":{split:1b}}},PickupDelay:10}
...
execute as @e[type=marker,tag=gen_forge,scores={gen_level=1}] if score @s gold >= gen.g1 config at @s run summon item ~ ~ ~ {Item:{id:"minecraft:gold_ingot",count:1,components:{"minecraft:custom_data":{split:1b}}},PickupDelay:10}
...
execute as @e[type=marker,tag=gen_forge,scores={gen_level=2}] if score @s iron >= gen.i2 config at @s run summon item ~ ~ ~ {Item:{id:"minecraft:iron_ingot",count:1,components:{"minecraft:custom_data":{split:1b}}},PickupDelay:10}
...
execute as @e[type=marker,tag=gen_forge,scores={gen_level=2}] if score @s gold >= gen.g2 config at @s run summon item ~ ~ ~ {Item:{id:"minecraft:gold_ingot",count:1,components:{"minecraft:custom_data":{split:1b}}},PickupDelay:10}
...
execute as @e[type=marker,tag=gen_forge,scores={gen_level=3..4}] if score @s iron >= gen.i3 config at @s run summon item ~ ~ ~ {Item:{id:"minecraft:iron_ingot",count:1,components:{"minecraft:custom_data":{split:1b}}},PickupDelay:10}
execute as @e[type=marker,tag=gen_forge,scores={gen_level=5}] if score @s iron >= gen.i3 config at @s run summon item ~ ~ ~ {Item:{id:"minecraft:iron_ingot",count:2,components:{"minecraft:custom_data":{split:1b}}},PickupDelay:10}
...
execute as @e[type=marker,tag=gen_forge,scores={gen_level=3..4}] if score @s gold >= gen.g3 config at @s run summon item ~ ~ ~ {Item:{id:"minecraft:gold_ingot",count:1,components:{"minecraft:custom_data":{split:1b}}},PickupDelay:10}
execute as @e[type=marker,tag=gen_forge,scores={gen_level=5}] if score @s gold >= gen.g3 config at @s run summon item ~ ~ ~ {Item:{id:"minecraft:gold_ingot",count:2,components:{"minecraft:custom_data":{split:1b}}},PickupDelay:10}
...
execute if score %diamond game matches 0 at @e[type=block_display,tag=gen_diamond] positioned ~ ~-3 ~ unless entity @e[type=item,nbt={Item:{id:"minecraft:diamond",count:8}},distance=..2] run summon item ~ ~3 ~ {Item:{id:"minecraft:diamond",count:1},PickupDelay:20}
...
execute if score %emerald game matches 0 at @e[type=block_display,tag=gen_emerald] run summon item ~ ~ ~ {Item:{id:"minecraft:emerald",count:1},PickupDelay:20}
execute if score %emerald game matches 0 at @e[type=marker,tag=gen_forge,scores={gen_level=4}] run summon item ~ ~ ~ {Item:{id:"minecraft:emerald",count:1},PickupDelay:20}
execute if score %emerald game matches 0 at @e[type=marker,tag=gen_forge,scores={gen_level=5}] run summon item ~ ~ ~ {Item:{id:"minecraft:emerald",count:2},PickupDelay:20}
...
# upgrade check
execute as @a store result score @s armor_check run clear @s chainmail_chestplate[custom_data={armor_level:2b}]
execute as @a[scores={armor_check=1..}] run function cc:armor_chainmail
execute as @a store result score @s armor_check run clear @s iron_chestplate[custom_data={armor_level:3b}]
execute as @a[scores={armor_check=1..}] run function cc:armor_iron
execute as @a store result score @s armor_check run clear @s diamond_chestplate[custom_data={armor_level:4b}]
execute as @a[scores={armor_check=1..}] run function cc:armor_diamond
execute as @a store result score @s armor_check run clear @s enchanted_book[custom_data={upgrade:1b}]
execute as @a[scores={armor_check=1..}] run function cc:upgrade_sharp
execute as @a store result score @s armor_check run clear @s golden_pickaxe[custom_data={upgrade:1b}]
