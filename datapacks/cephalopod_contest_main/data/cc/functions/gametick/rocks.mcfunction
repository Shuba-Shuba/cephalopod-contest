...
# generic stuff
execute as @a[gamemode=adventure] at @s if block ~ ~-1 ~ orange_concrete_powder run function cc:landed_no_kb
execute as @a[gamemode=adventure] at @s if block ~ ~-1 ~ light_blue_stained_glass run function cc:landed_no_kb
execute as @a[gamemode=adventure] at @s if block ~ ~-1 ~ white_stained_glass run function cc:landed_no_kb
...
#execute if score %rock game matches 5 run function cc:rock_crumble
execute if score %rock game matches 10 run function cc:rock_crumble
#execute if score %rock game matches 15 run function cc:rock_crumble
execute if score %rock game matches 20 run function cc:rock_crumble
#execute if score %rock game matches 25 run function cc:rock_crumble
execute if score %rock game matches 30 run function cc:rock_crumble
execute if score %rock game matches 30.. as @e[type=marker,tag=breaking,sort=random,limit=1] at @s unless score %second game matches 45.. run function cc:rock_destroy
execute if score %rock game matches 30.. as @e[type=marker,tag=tmp_rock,sort=random,limit=1] at @s unless score %second game matches 45.. run function cc:rock
