...
item modify entity @a[team=blue] armor.head cc:prot
item modify entity @a[team=blue] armor.chest cc:prot
item modify entity @a[team=blue] armor.legs cc:prot
item modify entity @a[team=blue] armor.feet cc:prot