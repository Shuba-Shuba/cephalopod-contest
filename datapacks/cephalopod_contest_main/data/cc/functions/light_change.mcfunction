...
execute if score %tmp_light3 game matches 1 run function cc:green_light
...
execute if score %tmp_light3 game matches 0 run schedule function cc:red_light 10t
#say light change