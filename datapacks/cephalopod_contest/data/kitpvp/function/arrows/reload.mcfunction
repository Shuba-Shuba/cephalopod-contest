...
execute if score @s Kit_ID matches 18 if score @s arrow_count < @s max_arrows run give @s minecraft:tipped_arrow[item_name="Lightning Arrow",lore=["Smites all players within 3.5 blocks upon impact"],potion_contents={custom_color:1957585,custom_effects:[{id:"minecraft:water_breathing",amplifier:31b,duration:2}]},tooltip_display={hidden_components:["potion_contents"]}]
