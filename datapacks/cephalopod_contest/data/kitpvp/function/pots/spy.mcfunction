...
# reload end
execute if score @s pot_cd.gdb matches 280.. run give @s minecraft:splash_potion[item_name={italic:false,text:"Invisibility Cloak"},potion_contents={custom_effects:[{id:"minecraft:invisibility",duration:200}],custom_color:16381689},custom_data={pot:1b}]
