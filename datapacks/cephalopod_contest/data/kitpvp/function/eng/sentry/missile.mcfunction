...
execute anchored eyes facing entity @p[distance=..20,gamemode=adventure,tag=!owner,nbt=!{active_effects:[{id:"minecraft:invisibility"}]},nbt=!{active_effects:[{id:"minecraft:resistance"}]}] eyes if entity @p[distance=..20,gamemode=adventure,tag=!owner,nbt=!{active_effects:[{id:"minecraft:invisibility"}]},nbt=!{active_effects:[{id:"minecraft:resistance"}]}] run function kitpvp:eng/sentry/missile_summon