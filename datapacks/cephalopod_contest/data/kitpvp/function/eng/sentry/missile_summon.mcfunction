execute anchored eyes run summon minecraft:armor_stand ~ ~1 ~ {Tags:["missile"],NoGravity:1b,Invisible:1b,Invulnerable:1b,equipment:{head:{id:"minecraft:tnt",count:1}}}
