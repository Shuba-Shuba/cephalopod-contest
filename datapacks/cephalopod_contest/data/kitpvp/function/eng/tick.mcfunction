...
execute if score %second eng_time matches 20.. run function kitpvp:eng/second
...
#execute if score %sentry eng_time matches 8.. as @e[tag=sentry,scores={sentry_level=1}] at @s run function kitpvp:eng/sentry/shoot
execute if score %sentry eng_time matches 10.. as @e[tag=sentry] at @s run function kitpvp:eng/sentry/shoot
execute if score %sentry eng_time matches 10.. run scoreboard players set %sentry eng_time 0
#execute if score %sentry_2 eng_time matches 6.. as @e[tag=sentry,scores={sentry_level=2}] at @s run function kitpvp:eng/sentry/shoot
#execute if score %sentry_2 eng_time matches 6.. run scoreboard players set %sentry_2 eng_time 0
#execute if score %sentry_3 eng_time matches 3.. as @e[tag=sentry,scores={sentry_level=3}] at @s run function kitpvp:eng/sentry/shoot
...
execute if score %missile eng_time matches 160.. as @e[tag=sentry,scores={sentry_level=2}] at @s run function kitpvp:eng/sentry/missile
...
execute as @a[scores={join=1..}] at @s run function kitpvp:eng/join

# store sentry count properly (this is like the 10th attempt at trying to do this)
execute as @a[scores={Kit_ID=23}] run function kitpvp:eng/sentry/check
execute as @a[scores={Kit_ID=25}] run function kitpvp:eng/sentry/check
execute as @a[scores={Kit_ID=39}] run function kitpvp:eng/sentry/check
tag @e[tag=sentry] remove owned_sentry

# sentry kill handler
execute as @a[scores={Kit_ID=23}] run function kitpvp:eng/sentry/kill
execute as @a[scores={Kit_ID=25}] run function kitpvp:eng/sentry/kill
execute as @a[scores={Kit_ID=39}] run function kitpvp:eng/sentry/kill
...
# homing missiles
execute as @e[tag=missile] at @s run function kitpvp:eng/missile_move
