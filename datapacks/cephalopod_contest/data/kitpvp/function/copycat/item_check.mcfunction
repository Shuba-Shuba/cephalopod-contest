...
execute as @e[type=item,distance=..2] if score @s UUID0 = %system UUID0 if score @s UUID1 = %system UUID1 if score @s UUID2 = %system UUID2 if score @s UUID3 = %system UUID3 run function kitpvp:copycat/return_item