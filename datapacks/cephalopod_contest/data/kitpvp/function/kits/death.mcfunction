...
execute if score @s Kit_ID matches 13 run function kitpvp:kits/gapple_classic
execute if score @s Kit_ID matches 14 run function kitpvp:kits/defenseless_tank
execute if score @s Kit_ID matches 15 run function kitpvp:kits/super_boots
execute if score @s Kit_ID matches 16 run function kitpvp:kits/kit_pro
execute if score @s Kit_ID matches 17 run function kitpvp:kits/kit_knight
execute if score @s Kit_ID matches 18 run function kitpvp:kits/wizard
execute if score @s Kit_ID matches 19 run function kitpvp:kits/kit_pp
execute if score @s Kit_ID matches 20 run function kitpvp:kits/cowboy
