...
give @s minecraft:lingering_potion[item_name={text:"Neurotoxin",color:"dark_green",italic:false},potion_contents={custom_effects:[{id:"minecraft:poison",amplifier:4b,duration:160}],custom_color:41995},custom_data={pot:1b}]