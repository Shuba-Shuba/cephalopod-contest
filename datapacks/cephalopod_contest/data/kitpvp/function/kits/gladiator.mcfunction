...
give @s minecraft:trident[unbreakable={},enchantments={loyalty:3},attribute_modifiers=[{operation:"add_value",type:"attack_damage",amount:3,slot:"mainhand",id:"melee"}],item_name={text:"Trident (3 melee damage)",italic:false}]
