...
give @s minecraft:trident[damage=0,max_damage=8,enchantments={loyalty:1},attribute_modifiers=[{operation:"add_value",type:"attack_damage",amount:1d,id:"melee"}],item_name={text:"Trident (1 melee damage)",italic:false}]
