...
give @s minecraft:barrier[item_name={text:"Copycat Slot",italic:false,color:"red"},lore=[{text:"This slot will copy the item the nearest",color:"gray"},{text:"player within 8 blocks is holding.",color:"gray"},"",{text:"This will usually be a melee weapon.",color:"gray"}]]
