...
give @s minecraft:petrified_oak_slab[item_name={text:"Build Floor [3x3]",italic:false},custom_data={nbk:1b}]
give @s minecraft:oak_planks[item_name={text:"Build Wall [3x3]",italic:false},custom_data={nbk:1b}]
