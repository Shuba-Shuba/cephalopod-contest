...
give @s minecraft:tipped_arrow[item_name="Ender Arrow",potion_contents={custom_effects:[{id:"minecraft:water_breathing",amplifier:33b,duration:2}]},tooltip_display={hidden_components:["potion_contents"]}] 3
give @s golden_apple
