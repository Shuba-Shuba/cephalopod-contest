...
execute unless entity @e[type=marker,tag=anchor,tag=match] run function rep:end
execute unless entity @e[type=marker,tag=anchor,tag=match] run tellraw @a {text:"ERROR: start of replay could not be found"}
