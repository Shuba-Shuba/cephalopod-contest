...
execute store result score .id itembox_cd run data get entity @s Inventory[{Slot:-106b}].components.minecraft:custom_data.nbk_id
tag @s add this
...
execute if data entity @s {Inventory:[{Slot:-106b,id:"minecraft:oak_planks"}]} if score @s Kit_ID matches 36 unless score @s build_cd matches 1.. run function kitpvp:build/wall
execute if data entity @s {Inventory:[{Slot:-106b,id:"minecraft:petrified_oak_slab"}]} if score @s Kit_ID matches 36 unless score @s build_cd matches 1.. run function kitpvp:build/floor
...
execute if data entity @s {Inventory:[{Slot:-106b,id:"minecraft:furnace"}]} if score @s Kit_ID matches 39 if score @s sentry_count matches 0 unless score @s build_cd matches 1.. at @s run function kitpvp:eng/sentry/build_lean
execute if data entity @s {Inventory:[{Slot:-106b,id:"minecraft:furnace"}]} if score @s Kit_ID matches 25 if score @s sentry_count matches 0 unless score @s build_cd matches 1.. at @s run function kitpvp:eng/sentry/build_lean
# mini tnt
