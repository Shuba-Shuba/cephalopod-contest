...
$scoreboard players operation .display calc = $(name) board_stars
scoreboard players operation .display calc *= integers.1000 calc
$scoreboard players operation .display calc += $(name) board_money
$scoreboard players operation $(name) board_display = .display calc

# display star count + money on scoreboard
$scoreboard players operation .stars calc = $(name) board_stars
$scoreboard players operation .money calc = $(name) board_money
...
$data modify storage tmp name set value "$(name)"
function cc:board/update_display_by_name_macro with storage tmp
