...
data modify storage cc:craft names append from block 0 -64 0 Items[0].components."minecraft:item_name"
data modify storage cc:craft names append from block 0 -64 0 Items[1].components."minecraft:item_name"
data modify storage cc:craft names append from block 0 -64 0 Items[2].components."minecraft:item_name"
data remove block 0 -64 0 Items