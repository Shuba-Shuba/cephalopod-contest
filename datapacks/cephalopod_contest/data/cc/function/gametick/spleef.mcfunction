...
execute if score %second game matches 0 if score %tick game matches 0 run function cc:spleef_timer
...
execute if score %players game matches ..1 run function cc:spleef_end