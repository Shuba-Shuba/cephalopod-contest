...
item replace entity @a[scores={class=0,gardener_jump=1..}] hotbar.1 with minecraft:diamond_shovel[unbreakable={},item_name={text:"KB 10 ACTIVATED",color:"aqua",italic:false},enchantments={knockback:10}]
item replace entity @a[scores={class=0,gardener_jump=0}] hotbar.1 with minecraft:stone_shovel[unbreakable={},item_name={text:"Market Gardener",color:"aqua",italic:false}]
...
item replace entity @a[scores={freeze_cd=1}] hotbar.3 with minecraft:splash_potion[item_name={text:"Freeze Potion",italic:false},potion_contents={custom_color:8911871,custom_effects:[{id:"minecraft:water_breathing",amplifier:32b,duration:500}]}]
...
# NUL laser cooldown
#execute as @a[scores={laser_cd=1}] run item replace entity @s hotbar.3 with minecraft:carrot_on_a_stick[item_name={text:"Laser",italic:false},custom_data={stats:{ammo:{type:7b}}}]
...
item replace entity @a[scores={triangulator_cd=1}] hotbar.1 with minecraft:bow[item_name={text:"Triangulator",italic:false},item_model="cc:holy_bow",damage=383,enchantments={"minecraft:infinity":1}]
