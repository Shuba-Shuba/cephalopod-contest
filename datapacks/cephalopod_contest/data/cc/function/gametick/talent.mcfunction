...
execute if score %second game matches ..0 if entity @a[tag=!stage,tag=!stage_done,tag=!ded,tag=!out] run function cc:talent_end
execute if score %second game matches ..0 unless entity @a[tag=!stage,tag=!stage_done,tag=!ded,tag=!out] run function cc:talent_vote
