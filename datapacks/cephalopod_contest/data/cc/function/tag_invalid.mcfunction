...
execute as @a[tag=!out,tag=!ded,scores={class=3}] if score @s UUID0 = .search UUID0 if score @s UUID1 = .search UUID1 if score @s UUID2 = .search UUID2 if score @s UUID3 = .search UUID3 run scoreboard players set @s triangulator_cd 100
