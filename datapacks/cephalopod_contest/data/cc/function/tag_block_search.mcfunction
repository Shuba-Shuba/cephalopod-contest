...
# summon "tagged block"
execute if score #bool game matches 1 at @s align xyz run summon slime ~.5 ~ ~.5 {Tags:["tnt_arc","init"],NoAI:1b,Size:1,Invulnerable:1b,Team:"no_pvp",active_effects:[{id:"minecraft:glowing",duration:-1,amplifier:0b,show_particles:0b},{id:"minecraft:invisibility",duration:-1,amplifier:0b,show_particles:0b}]}
