...
execute as @a[team=red] run function shb:give/pistol_bad
give @a[team=red] minecraft:iron_nugget[item_name={text:"Bullet",italic:false},custom_data={ammo:{type:1b}}] 128

# cop items
give @a[tag=cop] minecraft:stone_sword[unbreakable={},item_name={text:"Baton",italic:false}]
...
execute as @a[tag=cop] run function shb:give/pistol
execute as @a[tag=cop] run function shb:give/taser
give @a[tag=cop] minecraft:iron_nugget[item_name={text:"Bullet",italic:false},custom_data={ammo:{type:1b}}] 128
