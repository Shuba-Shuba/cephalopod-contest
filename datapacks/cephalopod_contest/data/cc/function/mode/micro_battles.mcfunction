...
give @a[tag=!out,tag=!ded] minecraft:stone_axe[unbreakable={},attribute_modifiers=[{operation:"add_value",type:"attack_damage",amount:4,slot:"mainhand",id:"melee"}],item_name={text:"Stone Axe (4 melee damage)",italic:false}]
