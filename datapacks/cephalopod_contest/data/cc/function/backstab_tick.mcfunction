...
item replace entity @a[scores={class=0,backstab_valid=1,backstab_cd=0}] hotbar.0 with minecraft:iron_sword[damage=249,custom_name={text:"GET THE BACKSTAB!!",italic:false},enchantments={knockback:10},item_model="cc:dagger",custom_data={backstab:1b}]
item replace entity @a[scores={class=0,backstab_valid=0,backstab_cd=0}] hotbar.0 with minecraft:iron_sword[damage=249,custom_name={text:"Backstabber",italic:false},item_model="cc:dagger",custom_data={backstab:1b}]