...
execute unless score %mode game matches 420 if score 1.8pvp config matches 1 as @a[predicate=cc:sword_follows_config,predicate=!cc:mainhand_blocks_attacks] run item modify entity @s weapon.mainhand cc:block_attacks
execute unless score %mode game matches 420 if score 1.8pvp config matches 0 as @a[predicate=cc:sword_follows_config,predicate=cc:mainhand_blocks_attacks] run item modify entity @s weapon.mainhand cc:no_blocking
