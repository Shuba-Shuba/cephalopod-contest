...
execute unless score .skyscraper heist matches 1.. unless entity @s[team=blue] run function cc:pothead/heist/skyscraper
...
execute if score .skyscraper heist matches 1 if entity @s[team=blue] run function cc:pothead/close/skyscraper