...
execute unless score .bank heist matches 1.. unless entity @s[team=blue] run function cc:pothead/heist/bank
...
execute if score .bank heist matches 1 if entity @s[team=blue] run function cc:pothead/close/bank