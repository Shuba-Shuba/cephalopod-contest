...
execute as @a[team=red] at @s positioned ~-240 ~-122 ~-790 if predicate cc:elevator_generic run tp @s 243.0 122 790.0 -90 0
schedule function cc:pothead/open/bank 60s