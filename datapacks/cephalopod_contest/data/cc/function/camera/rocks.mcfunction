...
execute if score %map game matches 0 if score %camera1 game matches 0 run summon item_display 133 109 333 {view_range:0.0f,Tags:["camera"]}
execute if score %map game matches 1 if score %camera1 game matches 0 run summon item_display 132 109 452 {view_range:0.0f,Tags:["camera"]}
execute if score %map game matches 2 if score %camera1 game matches 0 run summon item_display 223 109 453 {view_range:0.0f,Tags:["camera"]}
execute if score %map game matches 3 if score %camera1 game matches 0 run summon item_display 223 109 332 {view_range:0.0f,Tags:["camera"]}
