...
execute if score %camera1 game matches 0 if score %map game matches 0 run summon minecraft:item_display 1000 -47 -250 {view_range:0.0f,Tags:["camera"]}
execute if score %camera1 game matches 0 if score %map game matches 1 run summon minecraft:item_display 1317 -16 -232 {view_range:0.0f,Tags:["camera"]}
