...
execute if score %map game matches 0 if score %camera1 game matches 0 run summon item_display -215 118 1034 {view_range:0.0f,item:{id:"minecraft:air",count:1b},Tags:["camera"]}
execute if score %map game matches 1 if score %camera1 game matches 0 run summon item_display -215 118 1152 {view_range:0.0f,item:{id:"minecraft:air",count:1b},Tags:["camera"]}
execute if score %map game matches 2 if score %camera1 game matches 0 run summon item_display -215 118 1270 {view_range:0.0f,item:{id:"minecraft:air",count:1b},Tags:["camera"]}

# titles (ends at 180)
scoreboard players add %camera1 game 1
title @a[tag=!out] times 0 100 0
title @a[tag=!out] title "Sumo"
execute if score %camera1 game matches 0..60 unless score %duel game matches 1 run title @a[tag=!out] subtitle "2 people will fight a sumo match"
