...
# choose map
execute if score %map game matches 0 in cc:void run tp @a[tag=!out] 41 78 79
execute if score %map game matches 1 in cc:void run tp @a[tag=!out] 114 78 209
execute if score %map game matches 2 in cc:void run tp @a[tag=!out] -37 81 60
...
schedule function cc:mode/koth 8s