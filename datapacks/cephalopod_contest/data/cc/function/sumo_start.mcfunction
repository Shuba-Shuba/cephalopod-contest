...
execute if score %map game matches 2 unless score sumo_hazards.enabled config matches 1 run place template cc:sumo2_normal -222 112 1263 none none 1 0 strict
execute if score %map game matches 2 if score sumo_hazards.enabled config matches 1 run place template cc:sumo2_hazards -222 112 1263 none none 1 0 strict
