...
execute if entity @s[type=skeleton] run item replace entity @a[tag=owner,limit=1] hotbar.2 with minecraft:barrier[item_name={text:"On Cooldown",italic:false}]
...
execute if entity @s[type=creeper] run item replace entity @a[tag=owner,limit=1] hotbar.3 with minecraft:barrier[item_name={text:"On Cooldown",italic:false}]
