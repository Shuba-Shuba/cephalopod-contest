execute store result score @s items run clear @s carrot_on_a_stick{CustomModelData:11005} 0
execute if score @s items matches 1.. run function xp:demolitionist
execute if score @s items matches 0 run tag @s add no_demo

execute store result score @s items run clear @s stick{CustomModelData:11031} 0
