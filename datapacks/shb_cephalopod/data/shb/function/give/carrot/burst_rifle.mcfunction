data modify block 0 -64 0 Items append value {Slot:0b,id:"minecraft:carrot_on_a_stick",count:1b,components:{"minecraft:attribute_modifiers":[{type:"attack_speed",slot:"mainhand",id:"attack_speed",amount:-1000000,operation:"add_value"}],"minecraft:tooltip_display":{hidden_components:["attribute_modifiers"]},"minecraft:item_model":"shb:burst_rifle","minecraft:custom_data":{shb:1b}}}
