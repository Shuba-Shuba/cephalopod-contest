data modify block 0 -64 0 Items append value {Slot:0b,id:"minecraft:ender_eye",count:1b,components:{"minecraft:attribute_modifiers":[{type:"attack_speed",slot:"mainhand",id:"attack_speed",amount:-1000000,operation:"add_value",display:{type:"hidden"}}],"minecraft:item_model":"shb:item/sniper","minecraft:custom_data":{shb:1b}}}
