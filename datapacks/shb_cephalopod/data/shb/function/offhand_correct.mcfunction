...
clear @s carrot_on_a_stick[item_model="shb:invisible"]
...
item replace entity @s weapon.offhand with minecraft:carrot_on_a_stick[item_model="shb:invisible",custom_name=""]
