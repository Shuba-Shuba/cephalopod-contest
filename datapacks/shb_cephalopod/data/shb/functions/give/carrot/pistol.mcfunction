data modify block 0 -64 0 Items append value {Slot:0b,id:"minecraft:carrot_on_a_stick",Count:1b,tag:{shb:1b,CustomModelData:201,HideFlags:2,AttributeModifiers:[{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:-1000000,Operation:0,UUID:[I;211617564,1405111336,-1976366581,-1847700334],Slot:"mainhand"}]}}
