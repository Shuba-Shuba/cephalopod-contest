...
#execute unless predicate shb:swift_sneak run clear @s chainmail_leggings{shb:1b}
#execute unless data entity @s Inventory[{Slot:101b}] run item replace entity @s armor.legs with chainmail_leggings{shb:1b}
